...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<sqlite3-ruby>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<thin>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<skinny>.freeze, [">= 0.1.2".freeze])
